  ...
  group "grafana" {
    ...
    task "grafana" {
      ...
      env {
       ...
       GF_SERVER_ROOT_URL = "https://grafana.lgian.com"
       ...
       GF_AUTH_GENERIC_OAUTH_AUTH_URL = "https://id.lgian.com/realms/master/protocol/openid-connect/auth"
       GF_AUTH_GENERIC_OAUTH_TOKEN_URL = "https://id.lgian.com/realms/master/protocol/openid-connect/token"
       GF_AUTH_GENERIC_OAUTH_API_URL = "https://id.lgian.com/realms/master/protocol/openid-connect/userinfo"
